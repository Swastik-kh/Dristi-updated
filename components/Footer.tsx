...
const Footer: React.FC<FooterProps> = ({ facebookLink, twitterLink, youtubeLink, instagramLink }) => {
        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-between mb-4 border-b border-gray-700 pb-4">
          ...
          <div className="flex space-x-4">
            ...
            <a 
              ...
              className={`text-gray-400 hover:text-pink-600 transition-colors ${!instagramLink ? 'opacity-60 cursor-not-allowed' : ''}`}
