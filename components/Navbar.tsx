...
const Navbar: React.FC<NavbarProps> = ({ logoUrl, activeCategory, onCategoryChange, isSettingsLoaded }) => {
            ...
            >
              {!isSettingsLoaded ? (
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-black text-gray-900 text-base md:text-lg italic whitespace-nowrap">दृष्टि खबर</span>
                </div>
              )}
            </div>
          ...
          <div className="p-6 h-full flex flex-col">
            <div className="flex items-center justify-between mb-8">
               <div className="flex items-center space-x-2">
                  ...
                  <span className="font-black text-xl italic text-gray-900">दृष्टि खबर</span>
               </div>
